...
abstract class AppTextStyles {
  ...
  static const TextStyle titleStyleSmall = TextStyle(color: AppColors.primaryColorDark, fontSize: 14, fontWeight: FontWeight.w400);
  ...
  static const TextStyle bodyStyleSmall = TextStyle(color: AppColors.primaryColorDark, fontSize: 12, fontWeight: FontWeight.w400);
}
